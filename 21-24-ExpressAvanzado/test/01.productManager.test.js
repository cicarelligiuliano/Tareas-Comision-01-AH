...
describe('ProductManager', () => {
    ...
    describe('Initialize', () => {
        ...
        it('La funcion initialize se debe llamar en el constructor', () => {
            const spy = jest.spyOn(ProductManager.prototype, 'initialize');
    ...
    describe('addProduct', () => {
        ...
        it('Debe devolver el producto en el caso de que no exista ningun error', () => {
            productManager.initialize();
            expect(
                productManager.addProduct({
                    title: 'Producto 1',
    ...
    describe('editProduct', () => {
        ...
        it('Debe devolver el producto luego de actualizar el archivo', () => {
            productManager.initialize();
            productManager.addProduct({
                title: 'Producto 1',
                description: 'Descripcion 1',
    ...
    describe('deleteProduct', () => {
        ...
        it('Debe devolver el producto borrado si se elimino correctamente', () => {
            productManager.initialize();
            productManager.addProduct({
                title: 'Producto 1',
                description: 'Descripcion 1',
            ...
            expect(productManager.deleteProduct(1)).toMatchObject({
                title: 'Producto 1',
                description: 'Descripcion 1',
                price: 100,
                stock: 10,
