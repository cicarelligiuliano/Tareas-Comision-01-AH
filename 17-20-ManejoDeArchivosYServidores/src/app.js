...
//La segunda en la ruta "/products" devolvera todos los productos almacenados en el archivo products.json utilizando la instancia de la clase ProductManager por lo que sera necesaria instanciarla en el archivo en cuestion y NO dentro de la ruta.
